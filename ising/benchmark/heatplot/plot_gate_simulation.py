...
def plot_gate_error(
    ...
    taylor, trotter, qdrift, ktrotter = data["taylor"], data["trotter"], data["qdrift"], data["ktrotter"]
    ...
    ax.text(1.5, 2.20, 'First Order Trotterization', rotation=90, ha='center', va='center', color='black')
    ax.text(2.5, 2.10, 'Truncated Taylor Series', rotation=90, ha='center', va='center', color='black')
    ax.text(3.5, 1.60, 'kth Order Trotter', rotation=90, ha='center', va='center', color='black')
...
if __name__ == "__main__":
    ...
    plot_gate_error(
        qubit, h_val, err_pair, point_count, obs_norm, time_pair, file_name
    )
